...
elseif strcmp(SEG_TYPE,'thresh')
    [area_val,diam_val,flowPerHeartCycle_val,maxVel_val,PI_val,vmaxPI_val,RI_val, ...
        flowPulsatile_val,maxVelFrame,velMean_val,VplanesAllx,VplanesAlly,VplanesAllz, ...
