function [area_val,diam_val,flowPerHeartCycle_val,maxVel_val,PI_val,vmaxPI_val,RI_val,flowPulsatile_val,maxVelFrame,...
...
vmaxPI_val = abs(max(maxVelFrame,[],2) - min(maxVelFrame,[],2))./mean(maxVelFrame,2);
